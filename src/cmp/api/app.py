...
from cmp.api.routes.documents import router as documents_router
from cmp.api.routes.engagements import router as engagements_router
from cmp.api.routes.intake_form import router as intake_form_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(intake_form_router, prefix="/api/v1")
    ...
    @app.get("/intake")
    def client_intake() -> FileResponse:
        return FileResponse(static_dir / "client-intake.html")
